...
Vector Classes
--------------
These are the 3 and 4 vector classes, though the meat of these classes are
defined in _abstract_vectors.AbstractVectors.
"""
...
class ThreeVector(_abstract_vectors.AbstractVector):
    ...
    def __repr__(self):
        # type: () -> str
        return "ThreeVector(%s)" % repr(self._vector)
    ...
    def __make_new_vector(self, x, y, z):
...
class FourVector(_abstract_vectors.AbstractVector):
    ...
    def __repr__(self):
        # type: () -> str
        return "FourVector(%s)" % repr(self._vector)
